...
main(int argc, char *argv[])
{
  ...
  24:	360080e7          	jalr	864(ra) # 380 <fork>
    if(pid==0){ //son, read and send
  28:	c935                	beqz	a0,9c <main+0x9c>
        char s[30];
        read(0,s,30);
  ...
  2a:	0ca05b63          	blez	a0,100 <main+0x100>
        close(0);
  2e:	4501                	li	a0,0
  30:	00000097          	auipc	ra,0x0
  34:	380080e7          	jalr	896(ra) # 3b0 <close>
        dup(p_Pong[0]);
  38:	fe042503          	lw	a0,-32(s0)
  3c:	00000097          	auipc	ra,0x0
  40:	3c4080e7          	jalr	964(ra) # 400 <dup>
        write(p_Ping[1], "ww", sizeof("ww"));
  44:	460d                	li	a2,3
  46:	00001597          	auipc	a1,0x1
  4a:	86258593          	addi	a1,a1,-1950 # 8a8 <malloc+0x100>
  4e:	fec42503          	lw	a0,-20(s0)
  52:	00000097          	auipc	ra,0x0
  56:	356080e7          	jalr	854(ra) # 3a8 <write>
        close(p_Ping[1]);
  5a:	fec42503          	lw	a0,-20(s0)
  5e:	00000097          	auipc	ra,0x0
  62:	352080e7          	jalr	850(ra) # 3b0 <close>
        char s[30];
        read(0,s,30);
  66:	4679                	li	a2,30
  68:	fc040593          	addi	a1,s0,-64
  6c:	4501                	li	a0,0
  6e:	00000097          	auipc	ra,0x0
  72:	332080e7          	jalr	818(ra) # 3a0 <read>
        fprintf(1, "%d: received pong\n",getpid());
  76:	00000097          	auipc	ra,0x0
  7a:	392080e7          	jalr	914(ra) # 408 <getpid>
  7e:	862a                	mv	a2,a0
  80:	00001597          	auipc	a1,0x1
  84:	83058593          	addi	a1,a1,-2000 # 8b0 <malloc+0x108>
  88:	4505                	li	a0,1
  8a:	00000097          	auipc	ra,0x0
  8e:	638080e7          	jalr	1592(ra) # 6c2 <fprintf>
    }else{
  ...
  a0:	314080e7          	jalr	788(ra) # 3b0 <close>
        dup(p_Ping[0]);
  a4:	fe842503          	lw	a0,-24(s0)
  a8:	00000097          	auipc	ra,0x0
  ac:	358080e7          	jalr	856(ra) # 400 <dup>
        read(0,s,30);
  b0:	4679                	li	a2,30
  b2:	fc040593          	addi	a1,s0,-64
  b6:	4501                	li	a0,0
  b8:	00000097          	auipc	ra,0x0
  bc:	2e8080e7          	jalr	744(ra) # 3a0 <read>
        fprintf(1, "%d: received ping\n",getpid());
  c0:	00000097          	auipc	ra,0x0
  c4:	348080e7          	jalr	840(ra) # 408 <getpid>
  c8:	862a                	mv	a2,a0
  ca:	00000597          	auipc	a1,0x0
  ce:	7c658593          	addi	a1,a1,1990 # 890 <malloc+0xe8>
  d2:	4505                	li	a0,1
  d4:	00000097          	auipc	ra,0x0
  d8:	5ee080e7          	jalr	1518(ra) # 6c2 <fprintf>
        write(p_Pong[1],"ww",sizeof("ww"));
  dc:	460d                	li	a2,3
  de:	00000597          	auipc	a1,0x0
  e2:	7ca58593          	addi	a1,a1,1994 # 8a8 <malloc+0x100>
  e6:	fe442503          	lw	a0,-28(s0)
  ea:	00000097          	auipc	ra,0x0
  ee:	2be080e7          	jalr	702(ra) # 3a8 <write>
        close(p_Pong[1]);
  f2:	fe442503          	lw	a0,-28(s0)
  f6:	00000097          	auipc	ra,0x0
  fa:	2ba080e7          	jalr	698(ra) # 3b0 <close>
  fe:	bf51                	j	92 <main+0x92>
        fprintf(2, "fork error");
 100:	00000597          	auipc	a1,0x0
 104:	7c858593          	addi	a1,a1,1992 # 8c8 <malloc+0x120>
 108:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 470:	4cc50513          	addi	a0,a0,1228 # 938 <digits>
 474:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 574:	37070713          	addi	a4,a4,880 # 8e0 <malloc+0x138>
 ...
 5fe:	33eb8b93          	addi	s7,s7,830 # 938 <digits>
 ...
 652:	28a90913          	addi	s2,s2,650 # 8d8 <malloc+0x130>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7f8:	15c90913          	addi	s2,s2,348 # 950 <freep>
  if(p == (char*)-1)
 7fc:	5afd                	li	s5,-1
 7fe:	a895                	j	872 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 800:	00000797          	auipc	a5,0x0
 804:	15878793          	addi	a5,a5,344 # 958 <base>
